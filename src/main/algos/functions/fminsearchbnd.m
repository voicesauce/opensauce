...
% -- from matlab: optimset('fminsearch') =   
%
%                  Display: 'notify'
...
% -- from fminsearch.m -- options should be a vector, not a struct
% # @item options
...
if (nargin<5) || isempty(options)
  % FOR MATLAB: options = optimset('fminsearch');
  % FOR MATLAB (E.G.): options = optimset('Display', 'notify', 'MaxFunEvals', '200*numberofvariables', ...
  % 'MaxIter', '200*numberofvariables', 'TolFun', 1.0000e-04, 'TolX', 1.0000e-04, ...
